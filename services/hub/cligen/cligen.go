...
// RenderClient emits a binary's generated_client.go. schemas is the area's own published
// component schemas, which is where the human-readable table's default columns come from.
func RenderClient(ops []*hubapi.Operation, schemas map[string]map[string]any) ([]byte, error) {
